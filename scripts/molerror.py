...
h5s = glob.glob(f"../md_out/molarity/*-{suffix}.h5")
...
# USAGE: sbatch cpu.sh molerror prefix
...
for i in range(len(storage)):
    ...
    for j, t in enumerate(delays):
        conductivity[j] = conductivityCalc(currentDensityCalc(traj, t))
    ...
    with open('../txt_out/molarity.txt', 'a+') as f:
